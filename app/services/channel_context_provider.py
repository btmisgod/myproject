...
def ensure_channel_protocol_metadata(
...
def read_channel_protocol(
    metadata: dict[str, Any] | None,
    *,
    group_name: str,
    group_slug: str,
) -> dict[str, Any]:
    effective = ensure_channel_protocol_metadata(metadata, group_name=group_name, group_slug=group_slug)
