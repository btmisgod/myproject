...
class Message(UUIDMixin, TimestampMixin, Base):
    ...
    # Compatibility residue kept for skill-side round-trip safety during the audit window.
    author_kind: Mapped[str | None] = mapped_column(String(40), nullable=True, default=None)
    ...
    status_block_json: Mapped[dict[str, object]] = mapped_column(default=dict)
    context_block_json: Mapped[dict[str, object]] = mapped_column(default=dict)
